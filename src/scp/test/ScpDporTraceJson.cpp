...
terminalMetaFromJson(Json::Value const& value)
{
    ...
    terminal.mFocusThreadID = static_cast<dpor::model::ThreadId>(
        requireUint64(requireMember(object, "focus_thread_id", "terminal"),
...
threadTraceRecordFromJson(Json::Value const& value)
{
    ...
    record.mThreadID = static_cast<dpor::model::ThreadId>(
        requireUint64(requireMember(object, "thread", "thread_trace record"),
...
traceBundleFromJson(Json::Value const& value)
{
    ...
    TraceBundle bundle;
    bundle.mVersion = static_cast<int>(
