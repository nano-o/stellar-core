...
commit `0b2b788`, which contains seeded exhaustive branch ordering and is the
tip of upstream `main`. (The pin used to sit on
...
the revision selected by `stellar-core` before configuring:
```bash
